...
CREATE TABLE ordre (
    ...
    CONSTRAINT kunde FOREIGN KEY (kundeID) REFERENCES materialer(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT sælger FOREIGN KEY (sælgerID) REFERENCES materialer(id) ON DELETE CASCADE ON UPDATE CASCADE,
